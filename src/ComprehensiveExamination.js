...
const ComprehensiveExamination = (props) => {
	...
	if(props.flag===true && props.status==='unupdated'){
		return (
			<table className="outerTable">
				<tbody>
					<tr>
						<td className="pfield">COMPREHENSIVE EXAMINATION</td>
						<td>
								...
								<table className="innerTable">
									<tbody>
										...
										<tr>
											...
											<td className="pvalue"><input type="file" name="comprehensiveexamination" /></td>
										</tr>
										<tr>
